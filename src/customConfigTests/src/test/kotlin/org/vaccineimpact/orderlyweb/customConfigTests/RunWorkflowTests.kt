...
class RunWorkflowTests : SeleniumTest()
{
    ...
    fun `can select workflow progress tab and selecting a workflow option generates reports table`()
    {
        ...
        // val tableLabel = driver.findElement(By.tagName("label")
        // Assertions.assertThat(tableLabel).isEqualTo(2)
        // val tableRows = driver.findElements(By.tagName("tr"))
        // Assertions.assertThat(tableRows[0].text).contains("sfsf")

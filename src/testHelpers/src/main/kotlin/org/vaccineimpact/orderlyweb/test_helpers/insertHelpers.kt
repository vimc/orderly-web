...
fun insertDocuments()
{
    JooqContext().use {
        ...
        it.dsl.insertInto(ORDERLYWEB_DOCUMENT)
                .set(ORDERLYWEB_DOCUMENT.NAME, "some")
                .set(ORDERLYWEB_DOCUMENT.PATH, "/some/")
                .set(ORDERLYWEB_DOCUMENT.IS_FILE, 0)
                .execute()

        it.dsl.insertInto(ORDERLYWEB_DOCUMENT)
                .set(ORDERLYWEB_DOCUMENT.NAME, "root")
                .set(ORDERLYWEB_DOCUMENT.PATH, "/root/")
                .set(ORDERLYWEB_DOCUMENT.IS_FILE, 0)
                .execute()

        it.dsl.newRecord(ORDERLYWEB_DOCUMENT)
                .apply {
                    this.name = "path"
                    this.path = "/some/path/"
                    this.parent = "/some/"

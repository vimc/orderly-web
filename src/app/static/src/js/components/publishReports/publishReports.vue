    ...
    <div>
        ...
        <div class="mb-4 mt-2">
            <div class="mb-2 custom-control custom-checkbox">
                <input id="publishedOnly" v-model="publishedOnly" type="checkbox" class="custom-control-input">
        ...
        <report v-for="report in (reportsWithDrafts.filter(r => !publishedOnly || r.previously_published))"

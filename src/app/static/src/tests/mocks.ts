import {RunnerRootState, RunReportMetadata, RunWorkflowMetadata} from "../js/utils/types";
...
export const mockRunReportRootState = (props: Partial<RunnerRootState> = {}): RunnerRootState => {
    return {
        git: mockGitState(),
        ...props
    }

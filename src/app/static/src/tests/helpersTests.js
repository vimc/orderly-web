...
import {reportVersionToLongTimestamp, longDate} from "../js/components/helpers";
...
describe('helpers', () => {
    describe('reportVersionToLongTimestamp', () => {
        it('returns expected long timestamp string', () => {
            ...
            expect(result).to.eq("Tue May 14 2019, 13:46")
        });
        ...
        it('raises error when input is incorrect format', () => {
            ...
            expect(() => reportVersionToLongTimestamp("20190514X-134604-97c74832")).to.throw(expectedError);
        });
    });
    ...
    describe('longDate', () => {
        it('returns expected long date string', () => {
            ...
            expect(result).to.eq("Wed May 15 2019");
        });
    });

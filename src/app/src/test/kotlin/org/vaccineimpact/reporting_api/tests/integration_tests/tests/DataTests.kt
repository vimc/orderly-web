...
class DataTests : IntegrationTest() {
    ...
    fun `gets csv data file`() {
        ...
        val response = requestHelper.get("/reports/testname/testversion/data/testdata", ContentTypes.any)
    ...
    fun `gets 404 if data doesnt exist in db`() {
        ...
        val response = requestHelper.get("/reports/testname/testversion/data/$fakedata", ContentTypes.any)
    ...
    fun `gets rds data file`() {
        ...
        val response = requestHelper.get("/reports/testname/testversion/data/testdata?type=rds", ContentTypes.any)

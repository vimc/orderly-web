...
class VersionControllerTests : ControllerTest()
{
    ...
    fun `getRunMetadata returns orderly_run rds`()
    {
        ...
        val sut = VersionController(actionContext, mock(), mock(), fileSystem, mockConfig)
        sut.getRunMetadata()
    ...
    fun `getRunMetadata checks file exists`()
    {
        ...
        val sut = VersionController(actionContext, mockOrderlyClient, mock(), mock(), mockConfig)
    ...
    fun `getZippedByNameAndVersion returns zip of all files if user is a reviewer`()
    {
        ...
        val sut = VersionController(actionContext, mock(), mockZipClient, mockFiles, mockConfig)
    ...
    fun `getZippedByNameAndVersion only returns artefacts and resources if user is not a reviewer`()
    {
        ...
        val sut = VersionController(actionContext, mockOrderlyClient, mockZipClient,
                mock(), mockConfig)

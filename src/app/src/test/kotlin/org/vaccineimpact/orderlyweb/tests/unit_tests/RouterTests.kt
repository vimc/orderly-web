...
import org.vaccineimpact.orderlyweb.app_start.AuthenticationRouteBuilder
import org.vaccineimpact.orderlyweb.security.authentication.AuthenticationConfig
import org.vaccineimpact.orderlyweb.security.authentication.AuthenticationProvider
import org.vaccineimpact.orderlyweb.test_helpers.TeamcityTests

class AuthenticationControllerTests() : TeamcityTests()
{
    @Test
    fun `creates GitHub logout callback`()
    {
        ...
        val sut = AuthenticationRouteBuilder(mockAuthConfig)
        val result = sut.logoutRoute()

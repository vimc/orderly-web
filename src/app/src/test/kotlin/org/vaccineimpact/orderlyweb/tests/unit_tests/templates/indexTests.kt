...
class indexTests: TeamcityTests()
{
    ...
    fun `renders correctly`()
    {
        ...
        assertThat(xmlResponse, XmlMatchers.hasXPath("//h1/text()", equalToIgnoringWhiteSpace("All reports")))

        assertThat(xmlResponse, XmlMatchers.hasXPath("//div[@id='content']/a[1]/text()",
                equalToIgnoringWhiteSpace("r1")))
        assertThat(xmlResponse, XmlMatchers.hasXPath("//div[@id='content']/a[1]/@href", equalTo("reports/r1/v1")))

        assertThat(xmlResponse, XmlMatchers.hasXPath("//div[@id='content']/a[2]/text()",
                equalToIgnoringWhiteSpace("r2")))
        assertThat(xmlResponse, XmlMatchers.hasXPath("//div[@id='content']/a[2]/@href", equalTo("reports/r2/v2")))

...
class HomeControllerTests : TeamcityTests()
{
    ...
    fun `builds report rows`()
    {
        ...
        val fakeReports = listOf(ReportVersion("r1", "r1 display name", "v1", "v2", true, date, author, requester),
                ...
                ReportVersion("r2", "r2 display name", "r2v1", "r2v1", true, date, "another author", "another requester"))
        ...
        val expected = listOf(ReportRowViewModel(1, 0, "r1", null, "v2", null, 2, null, null, null),
                ReportRowViewModel(2, 1, "r1", "v1", "v2", "Thu May 23 2019, 12:31", 2, true, author, requester),
                ReportRowViewModel(3, 1, "r1", "v2", "v2", "Thu May 23 2019, 12:31", 2, false, author, requester),
                ReportRowViewModel(4, 0, "r2", null, "r2v1", null, 1, null, null, null),
                ReportRowViewModel(5, 4, "r2", "r2v1", "r2v1", "Thu May 23 2019, 12:31", 1, true, "another author", "another requester")
        )

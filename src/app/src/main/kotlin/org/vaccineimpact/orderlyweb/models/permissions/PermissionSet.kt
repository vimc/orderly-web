...
{
    constructor(vararg rawPermissions: String) : this(rawPermissions.map { ReifiedPermission.parse(it) }.toSet())
    constructor(rawPermissions: Iterable<String>) : this(rawPermissions.map { ReifiedPermission.parse(it) }.toSet())

...
public class DefaultSchema extends SchemaImpl {
     ...
     */
    public final ArtefactFormat ARTEFACT_FORMAT = ArtefactFormat.ARTEFACT_FORMAT;
     ...
     */
    public final ChangelogLabel CHANGELOG_LABEL = ChangelogLabel.CHANGELOG_LABEL;

    /**
     * The table <code>custom_fields</code>.
     */
    public final CustomFields CUSTOM_FIELDS = CustomFields.CUSTOM_FIELDS;
     ...
     */
    public final Depends DEPENDS = Depends.DEPENDS;
     ...
     */
    public final FileArtefact FILE_ARTEFACT = FileArtefact.FILE_ARTEFACT;

    /**
     * The table <code>file_input</code>.
     */
    public final FileInput FILE_INPUT = FileInput.FILE_INPUT;

    /**
     * The table <code>file_input_global</code>.
     */
    public final FileInputGlobal FILE_INPUT_GLOBAL = FileInputGlobal.FILE_INPUT_GLOBAL;

    /**
     * The table <code>file_purpose</code>.
     */
    public final FilePurpose FILE_PURPOSE = FilePurpose.FILE_PURPOSE;

    /**
     * The table <code>orderly_schema</code>.
     */
    public final OrderlySchema ORDERLY_SCHEMA = OrderlySchema.ORDERLY_SCHEMA;

    /**
     * The table <code>orderly_schema_tables</code>.
     */
    public final OrderlySchemaTables ORDERLY_SCHEMA_TABLES = OrderlySchemaTables.ORDERLY_SCHEMA_TABLES;

    /**
     * The table <code>orderlyweb_document</code>.
     */
    public final OrderlywebDocument ORDERLYWEB_DOCUMENT = OrderlywebDocument.ORDERLYWEB_DOCUMENT;

    /**
     * The table <code>orderlyweb_permission</code>.
     */
    public final OrderlywebPermission ORDERLYWEB_PERMISSION = OrderlywebPermission.ORDERLYWEB_PERMISSION;
     ...
     */
    public final OrderlywebReportTag ORDERLYWEB_REPORT_TAG = OrderlywebReportTag.ORDERLYWEB_REPORT_TAG;

    /**
     * The table <code>orderlyweb_report_version</code>.
     */
    public final OrderlywebReportVersion ORDERLYWEB_REPORT_VERSION = OrderlywebReportVersion.ORDERLYWEB_REPORT_VERSION;

    /**
     * The table <code>orderlyweb_report_version_full</code>.
     */
    public final OrderlywebReportVersionFull ORDERLYWEB_REPORT_VERSION_FULL = OrderlywebReportVersionFull.ORDERLYWEB_REPORT_VERSION_FULL;

    /**
     * The table <code>orderlyweb_report_version_tag</code>.
     */
    public final OrderlywebReportVersionTag ORDERLYWEB_REPORT_VERSION_TAG = OrderlywebReportVersionTag.ORDERLYWEB_REPORT_VERSION_TAG;

    /**
     * The table <code>orderlyweb_settings</code>.
     */
    public final OrderlywebSettings ORDERLYWEB_SETTINGS = OrderlywebSettings.ORDERLYWEB_SETTINGS;

    /**
     * The table <code>orderlyweb_user</code>.
     */
    public final OrderlywebUser ORDERLYWEB_USER = OrderlywebUser.ORDERLYWEB_USER;

    /**
     * The table <code>orderlyweb_user_group</code>.
     */
    public final OrderlywebUserGroup ORDERLYWEB_USER_GROUP = OrderlywebUserGroup.ORDERLYWEB_USER_GROUP;

    /**
     * The table <code>orderlyweb_user_group_global_permission</code>.
     */
    public final OrderlywebUserGroupGlobalPermission ORDERLYWEB_USER_GROUP_GLOBAL_PERMISSION = OrderlywebUserGroupGlobalPermission.ORDERLYWEB_USER_GROUP_GLOBAL_PERMISSION;

    /**
     * The table <code>orderlyweb_user_group_permission</code>.
     */
    public final OrderlywebUserGroupPermission ORDERLYWEB_USER_GROUP_PERMISSION = OrderlywebUserGroupPermission.ORDERLYWEB_USER_GROUP_PERMISSION;

    /**
     * The table <code>orderlyweb_user_group_permission_all</code>.
     */
    public final OrderlywebUserGroupPermissionAll ORDERLYWEB_USER_GROUP_PERMISSION_ALL = OrderlywebUserGroupPermissionAll.ORDERLYWEB_USER_GROUP_PERMISSION_ALL;

    /**
     * The table <code>orderlyweb_user_group_report_permission</code>.
     */
    public final OrderlywebUserGroupReportPermission ORDERLYWEB_USER_GROUP_REPORT_PERMISSION = OrderlywebUserGroupReportPermission.ORDERLYWEB_USER_GROUP_REPORT_PERMISSION;

    /**
     * The table <code>orderlyweb_user_group_user</code>.
     */
    public final OrderlywebUserGroupUser ORDERLYWEB_USER_GROUP_USER = OrderlywebUserGroupUser.ORDERLYWEB_USER_GROUP_USER;

    /**
     * The table <code>orderlyweb_user_group_version_permission</code>.
     */
    public final OrderlywebUserGroupVersionPermission ORDERLYWEB_USER_GROUP_VERSION_PERMISSION = OrderlywebUserGroupVersionPermission.ORDERLYWEB_USER_GROUP_VERSION_PERMISSION;
     ...
     */
    public final ParametersType PARAMETERS_TYPE = ParametersType.PARAMETERS_TYPE;
     ...
     */
    public final ReportBatch REPORT_BATCH = ReportBatch.REPORT_BATCH;

    /**
     * The table <code>report_version</code>.
     */
    public final ReportVersion REPORT_VERSION = ReportVersion.REPORT_VERSION;

    /**
     * The table <code>report_version_artefact</code>.
     */
    public final ReportVersionArtefact REPORT_VERSION_ARTEFACT = ReportVersionArtefact.REPORT_VERSION_ARTEFACT;

    /**
     * The table <code>report_version_batch</code>.
     */
    public final ReportVersionBatch REPORT_VERSION_BATCH = ReportVersionBatch.REPORT_VERSION_BATCH;

    /**
     * The table <code>report_version_custom_fields</code>.
     */
    public final ReportVersionCustomFields REPORT_VERSION_CUSTOM_FIELDS = ReportVersionCustomFields.REPORT_VERSION_CUSTOM_FIELDS;
     ...
     */
    public final ReportVersionTag REPORT_VERSION_TAG = ReportVersionTag.REPORT_VERSION_TAG;

    /**
     * The table <code>report_version_view</code>.
     */
    public final ReportVersionView REPORT_VERSION_VIEW = ReportVersionView.REPORT_VERSION_VIEW;

    /**
     * The table <code>report_version_workflow</code>.
     */
    public final ReportVersionWorkflow REPORT_VERSION_WORKFLOW = ReportVersionWorkflow.REPORT_VERSION_WORKFLOW;
    ...
    public final List<Table<?>> getTables() {
        return Arrays.<Table<?>>asList(
            ...
            OrderlywebSettings.ORDERLYWEB_SETTINGS,

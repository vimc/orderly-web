...
public class OrderlywebReportVersionFullRecord extends TableRecordImpl<OrderlywebReportVersionFullRecord> implements Record11<String, String, Timestamp, String, String, Boolean, Double, String, String, Boolean, Boolean> {

    private static final long serialVersionUID = -363751652;
    ...
    @Override
    public Row11<String, String, Timestamp, String, String, Boolean, Double, String, String, Boolean, Boolean> valuesRow() {
    ...
    @Override
    public OrderlywebReportVersionFullRecord value11(Boolean value) {
        setPublished(value);
        return this;
    }

    @Override
    public OrderlywebReportVersionFullRecord values(String value1, String value2, Timestamp value3, String value4, String value5, Boolean value6, Double value7, String value8, String value9, Boolean value10, Boolean value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrderlywebReportVersionFullRecord(String id, String report, Timestamp date, String displayname, String description, Boolean connection, Double elapsed, String gitSha, String gitBranch, Boolean gitClean, Boolean published) {
        super(OrderlywebReportVersionFull.ORDERLYWEB_REPORT_VERSION_FULL);

...
import org.vaccineimpact.orderlyweb.db.tables.records.FlywaySchemaHistoryRecord;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
    ...
    private static final long serialVersionUID = -170103911;
     ...
     */
    public final TableField<FlywaySchemaHistoryRecord, String> INSTALLED_ON = createField("installed_on", org.jooq.impl.SQLDataType.CLOB.nullable(false).defaultValue(org.jooq.impl.DSL.field("strftime('%Y-%m-%d %H:%M:%f','now')", org.jooq.impl.SQLDataType.CLOB)), this, "");
    ...
    public List<UniqueKey<FlywaySchemaHistoryRecord>> getKeys() {
        return Arrays.<UniqueKey<FlywaySchemaHistoryRecord>>asList(Keys.PK_FLYWAY_SCHEMA_HISTORY);
    }

...
public class ReportVersionRecord extends UpdatableRecordImpl<ReportVersionRecord> implements Record11<String, String, Timestamp, String, String, Boolean, Boolean, Double, String, String, Boolean> {

    private static final long serialVersionUID = -477476127;
    ...
    @Override
    public Row11<String, String, Timestamp, String, String, Boolean, Boolean, Double, String, String, Boolean> valuesRow() {
    ...
    @Override
    public ReportVersionRecord values(String value1, String value2, Timestamp value3, String value4, String value5, Boolean value6, Boolean value7, Double value8, String value9, String value10, Boolean value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReportVersionRecord(String id, String report, Timestamp date, String displayname, String description, Boolean connection, Boolean published, Double elapsed, String gitSha, String gitBranch, Boolean gitClean) {
        super(ReportVersion.REPORT_VERSION);

...
public class ReportVersionRecord extends UpdatableRecordImpl<ReportVersionRecord> implements Record10<String, String, Timestamp, String, String, Boolean, Boolean, String, String, String> {

    private static final long serialVersionUID = 1543847817;
     ...
     */
    @Override
    public Row10<String, String, Timestamp, String, String, Boolean, Boolean, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row10<String, String, Timestamp, String, String, Boolean, Boolean, String, String, String> valuesRow() {
     ...
     */
    @Override
    public ReportVersionRecord values(String value1, String value2, Timestamp value3, String value4, String value5, Boolean value6, Boolean value7, String value8, String value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReportVersionRecord(String id, String report, Timestamp date, String displayname, String description, Boolean connection, Boolean published, String requester, String author, String comment) {
        super(ReportVersion.REPORT_VERSION);

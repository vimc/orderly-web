...
public class ReportRecord extends UpdatableRecordImpl<ReportRecord> implements Record1<String> {

    private static final long serialVersionUID = 1721870500;
     ...
     */
    @Override
    public ReportRecord values(String value1) {
        value1(value1);
        return this;
    }
     ...
     */
    public ReportRecord(String name) {
        super(Report.REPORT);
